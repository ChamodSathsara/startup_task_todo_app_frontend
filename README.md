...
NEXT_PUBLIC_API_URL=https://startuptasktodoapp-production.up.railway.app
...
Backend may be hosted on Render free tier
Initial API request may take a few seconds due to cold start
